...
The package includes a toy data for demonstration purpose. The $50\times10$ predictor matrix `x` is generated from standard normal distribution and `y` is generated according to$$y_i\sim \mathrm{Tweedie}(\mu=\sin(\mathbf{x_i}^\top\beta), \rho=1.5,\phi=0.5),$$where $\beta=(6, -4, 3, 2, -2, 0,\ldots,0)$. That said, only the first five predictors are associated with the response.
